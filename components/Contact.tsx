        ...
        <div className=" w-full md:w-2/6 flex flex-col">
          ...
          <div className="flex items-center p-6">
            ...
            <div className="ml-4">
              ...
              <h3 className="text-gray-600">+54 9 11 4408 0057</h3>
            </div>
          </div>
          ...
          <div className="flex items-center p-6">
            ...
            <div className="ml-4">
              ...
              <h3 className="text-gray-600">zeregalihuel@gmail.com</h3>
            </div>
          </div>
          ...
          <div className="flex items-center p-6">
            ...
            <div className="ml-4">
              ...
              <h3 className="text-gray-600">Buenos Aires, Argentina</h3>
            </div>
          </div>
        </div>
